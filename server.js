...
app.post('/submit', function(req,res){
  ...
  // Start RADAR child process
    ...
    // Radar successfully solved model, send result
    else {

      try {

        var resfilepath = __dirname+'/radar-output/'+modelName+'/ICSE/AnalysisResult/'+modelName+'.csv';
        var pyoptions = {
            mode: 'text',
            args: [resfilepath]
        }
        ...
        PythonShell.run('processing.py', pyoptions, function(err, pyres){
          ...
          console.log('Pyshell result: ',pyres);
        ...
        // Error reading radar output, send error
        result.body = err;
        result.type = 'error';
        res.send(result);
      }
